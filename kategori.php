...
<?php
  ...
  $query= query("SELECT * FROM kategori ORDER BY tanggal_input DESC LIMIT $awalData, $jumlahDataPerHalaman");

  if(isset($_POST['tombol_search'])){
    $query = search_dataktgr($_POST['keyword']);
  }
...
<html lang="en">
  ...
  <head>
    ...
    <title>BookSpace Studio | Kategori</title>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <a href="tambahdata_kategori.php">
                ...
                <table class="table table-striped table-hover">
                  ...
                  <?php foreach ($query as $kategori) : ?>
                    <tr>
                      ...
                      <td><?= date("d-m-Y", strtotime($kategori["tanggal_input"])); ?></td>
                      <td>
                        <a href="ubahdata_kategori.php?id=<?= $kategori['id_kategori']; ?>" class="btn btn-success btn-sm">Edit</a>
                        <a href="hapusdata_kategori.php?id=<?= $kategori['id_kategori']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                     </td>
                    </tr>
                  <?php endforeach; ?>
                </table>
