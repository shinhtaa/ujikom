...
if(isset($_POST['tombol_submit'])){
   if(ubah_data($_POST) > 0){
    echo "
      <script>
        alert('Data berhasil diubah ke database!');
    ...
    ";
      ...
      echo "
        <script>
          alert('Data gagal diubah ke database!');
          document.location.href = 'index.php';
        </script>
      ";
    }
...
<html lang="en">
  ...
  <head>
    ...
    <title>BookSpace Studio | Ubah Data</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Ubah Data Buku</h3>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="id_buku" value="<?= $buku['id_buku']; ?>">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="judul" value="<?= $buku['judul']; ?>" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Penulis</label>
                        <input type="text" class="form-control" name="penulis" value="<?= $buku['penulis']; ?>" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" rows="3" autocomplete="off" required><?= $buku['deskripsi']; ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="tahun_terbit" value="<?= $buku['tahun_terbit']; ?>" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
